        ...
        <div class="container my-5 mx-auto">
            <div class="row p-5"  style="background-color: #fff; opacity: 0.7;">
                <div class="col-xs-12 col-sm-12">
                    ...
                    <h2 class="text-center" >iPad шаблон</h2>
                    <div class="shortstory">
                    	<p class="text-center" >
                    		Это демо-страница отображается только для устройств apple iPad.
                            Шаблон называется <b>mobile-ipad</b> и находится по адресу /templates/mobile-ipad/ 
                        </p>
                        <p class="text-center" >
