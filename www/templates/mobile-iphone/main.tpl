        ...
        <div class="container my-5 mx-auto">
            <div class="row p-5"  style="background-color: #fff; opacity: 0.7;">
                <div class="col-xs-12 col-sm-6">
                	<div class="py-2">
    					<h1 class="text-center" ><i class="fa fa-apple fa-5x" aria-hidden="true"></i></h1>
    				</div>
                    <h2 class="text-center" >iPhone шаблон</h2>
                    <div class="shortstory">
                    	<p class="text-center" >
                    		Это демо-страница отображается только для устройств apple iPhone.
                            Шаблон называется <b>mobile-iphone</b> и находится по адресу /templates/mobile-iphone/ 
                        </p>
                        <p class="text-center" >
